...
const appConfig$1 = {"name":"vinxi","routers":[{"name":"public","type":"static","dir":"./public","base":"/","root":"/Users/jonasgraterol/Development/TRINIDAPP/website","order":0,"outDir":"/Users/jonasgraterol/Development/TRINIDAPP/website/.vinxi/build/public"},{"name":"client","type":"client","target":"browser","handler":"app/client.tsx","base":"/_build","build":{"sourcemap":true},"root":"/Users/jonasgraterol/Development/TRINIDAPP/website","outDir":"/Users/jonasgraterol/Development/TRINIDAPP/website/.vinxi/build/client","order":1},{"name":"ssr","type":"http","target":"server","handler":"app/ssr.tsx","link":{"client":"client"},"root":"/Users/jonasgraterol/Development/TRINIDAPP/website","base":"/","outDir":"/Users/jonasgraterol/Development/TRINIDAPP/website/.vinxi/build/ssr","order":2},{"name":"server","type":"http","target":"server","base":"/_server","handler":"node_modules/@tanstack/start-server-functions-handler/dist/esm/index.js","root":"/Users/jonasgraterol/Development/TRINIDAPP/website","outDir":"/Users/jonasgraterol/Development/TRINIDAPP/website/.vinxi/build/server","order":3}],"server":{"preset":"node-server","experimental":{"asyncContext":true}},"root":"/Users/jonasgraterol/Development/TRINIDAPP/website"};
				const buildManifest = {"client":{"_client-BD0x6cCO.js":{"file":"assets/client-BD0x6cCO.js","name":"client","dynamicImports":["app/routes/index.tsx?tsr-split=component"],"css":["assets/client-CY7WGVNl.css"]},"_client-CY7WGVNl.css":{"file":"assets/client-CY7WGVNl.css","src":"_client-CY7WGVNl.css"},"app/routes/index.tsx?tsr-split=component":{"file":"assets/index-Bnbz5fA8.js","name":"index","src":"app/routes/index.tsx?tsr-split=component","isDynamicEntry":true,"imports":["_client-BD0x6cCO.js"]},"virtual:$vinxi/handler/client":{"file":"assets/client-CLP_h_y_.js","name":"client","src":"virtual:$vinxi/handler/client","isEntry":true,"imports":["_client-BD0x6cCO.js"]}},"ssr":{"app/routes/index.tsx?tsr-split=component":{"file":"assets/index-CsObXEje.js","name":"index","src":"app/routes/index.tsx?tsr-split=component","isDynamicEntry":true,"imports":["virtual:$vinxi/handler/ssr"]},"virtual:$vinxi/handler/ssr":{"file":"ssr.js","name":"ssr","src":"virtual:$vinxi/handler/ssr","isEntry":true,"dynamicImports":["app/routes/index.tsx?tsr-split=component"],"css":["assets/ssr-CY7WGVNl.css"]}},"server":{"virtual:$vinxi/handler/server":{"file":"server.js","name":"server","src":"virtual:$vinxi/handler/server","isEntry":true}}};
...
const assets$1 = {
  "/assets/ssr-CY7WGVNl.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"a1b1-GWVXRgefTVH0NU3k79q30x/64uo\"",
    "mtime": "2025-02-20T21:56:47.096Z",
    "size": 41393,
    "path": "../public/assets/ssr-CY7WGVNl.css"
  },
  "/_build/.vite/manifest.json": {
    "type": "application/json",
    "etag": "\"329-qTy/Oa2/aAIqfTx+bXrWAUsLoek\"",
    "mtime": "2025-02-20T21:56:47.094Z",
    "size": 809,
    "path": "../public/_build/.vite/manifest.json"
  },
  "/_build/assets/client-BD0x6cCO.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"3e2a8-ZopI02eG/ozthZgmyFmOjiJ5pRI\"",
    "mtime": "2025-02-20T21:56:47.095Z",
    "size": 254632,
    "path": "../public/_build/assets/client-BD0x6cCO.js"
  },
  "/_build/assets/client-CLP_h_y_.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"3f-8nKOg7qHQ4RuyfiZfsleTFsiZ8E\"",
    "mtime": "2025-02-20T21:56:47.095Z",
    "size": 63,
    "path": "../public/_build/assets/client-CLP_h_y_.js"
  },
  "/_build/assets/client-CY7WGVNl.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"a1b1-GWVXRgefTVH0NU3k79q30x/64uo\"",
    "mtime": "2025-02-20T21:56:47.095Z",
    "size": 41393,
    "path": "../public/_build/assets/client-CY7WGVNl.css"
  },
  "/_build/assets/index-Bnbz5fA8.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"9139-8CPixiwcUkENUrajxp4EuJHROmQ\"",
    "mtime": "2025-02-20T21:56:47.095Z",
    "size": 37177,
    "path": "../public/_build/assets/index-Bnbz5fA8.js"
  }
};
...
const _e4xTzM = eventHandler((event) => {
...
} }, p = (e, t, n, r) => ({ key: e, stringifyCondition: t, stringify: (o) => ({ [`$${e}`]: n(o) }), parseCondition: (o) => Object.hasOwn(o, `$${e}`), parse: (o) => r(o[`$${e}`]) }), y$1 = [p("undefined", (e) => e === void 0, () => 0, () => {
...
function J(e) {
  var _a;
  return (_a = e.web) != null ? _a : e.web = { request: W(e), url: q(e) }, e.web.request;
}
function U() {
  return $();
}
const _$1 = Symbol("$HTTPEvent");
function B$1(e) {
...
function C(e) {
  return function(...t) {
    var n;
    const r = t[0];
    if (B$1(r)) t[0] = r instanceof H3Event || r.__is_event__ ? r : r[_$1];
    else {
...
const q = C(getRequestURL), V = C(getResponseStatus), G = C(getRequestWebStream);
function K() {
  var e;
...
const Q = {}, oe = eventHandler(X), h = Q;
async function X(e) {
  const t = J(e);
  return await Z({ request: t, event: e });
}
function Y(e) {
  return e.replace(/^\/|\/$/g, "");
}
async function Z({ request: e, event: t }) {
  const n = new AbortController(), r = n.signal, o = () => n.abort();
  t.node.req.on("close", o);
  const i = e.method, f = new URL(e.url, "http://localhost:3000"), j = new RegExp(`${Y("/_server")}/([^/?#]+)`), E = f.pathname.match(j), u = E ? E[1] : null, w = Object.fromEntries(f.searchParams.entries()), S = "createServerFn" in w;
  if (typeof u != "string") throw new Error("Invalid server action param for serverFnId: " + u);
  const b = h[u];
  if (!b) throw console.log("serverFnManifest", h), new Error("Server function info not found for " + u);
  let l;
  if (l = await b.importer(), !l) throw console.log("serverFnManifest", h), new Error("Server function module not resolved for " + u);
  const d = l[b.functionName];
  if (!d) throw console.log("serverFnManifest", h), console.log("fnModule", l), new Error(`Server function module export not resolved for serverFn ID: ${u}`);
  const D = ["multipart/form-data", "application/x-www-form-urlencoded"], R = await (async () => {
    try {
      let s = await (async () => {
        if (e.headers.get("Content-Type") && D.some((a) => {
          var T;
          return (T = e.headers.get("Content-Type")) == null ? void 0 : T.includes(a);
        })) return L(i.toLowerCase() !== "get", "GET requests with FormData payloads are not supported"), await d(await e.formData(), r);
        if (i.toLowerCase() === "get") {
          let a = w;
          return S && (a = w.payload), a = a && c.parse(a), await d(a, r);
        }
        const g = await e.text(), x = c.parse(g);
        return S ? await d(x, r) : await d(...x, r);
      })();
      return s instanceof Response || !S && (s = s.result, s instanceof Response) ? s : isRedirect$1(s) || isNotFound(s) ? O(s) : new Response(s !== void 0 ? c.stringify(s) : void 0, { status: V($()), headers: { "Content-Type": "application/json" } });
    } catch (s) {
      return s instanceof Response ? s : isRedirect$1(s) || isNotFound(s) ? O(s) : (console.info(), console.info("Server Fn Error!"), console.info(), console.error(s), console.info(), new Response(c.stringify(s), { status: 500, headers: { "Content-Type": "application/json" } }));
    }
  })();
  if (t.node.req.removeListener("close", o), R.headers.get("Content-Type") === "application/json") {
    const g = await R.clone().text();
...
const y = { stringify: (e) => JSON.stringify(e, function(t, s) {
  const n = this[t], o = b.find((i) => i.stringifyCondition(n));
  return o ? o.stringify(n) : s;
}), parse: (e) => JSON.parse(e, function(t, s) {
  const n = this[t];
  if (isPlainObject$1(n)) {
    const o = b.find((i) => i.parseCondition(n));
  ...
  const r = b.find((t) => t.stringifyCondition(e));
  return r ? r.stringify(e) : e;
}, decode: (e) => {
  if (isPlainObject$1(e)) {
    const r = b.find((t) => t.parseCondition(e));
...
} }, _ = (e, r, t, s) => ({ key: e, stringifyCondition: r, stringify: (n) => ({ [`$${e}`]: t(n) }), parseCondition: (n) => Object.hasOwn(n, `$${e}`), parse: (n) => s(n[`$${e}`]) }), b = [_("undefined", (e) => e === void 0, () => 0, () => {
...
function pe(e, r) {
  e.ssr = { manifest: r, serializer: y }, e.serverSsr = { injectedHtml: [], streamedKeys: /* @__PURE__ */ new Set(), injectHtml: (t) => {
    ...
    warning(!e.serverSsr.streamedKeys.has(t), "Key has already been streamed: " + t), e.serverSsr.streamedKeys.add(t), e.serverSsr.injectScript(() => `__TSR_SSR__.streamedValues['${t}'] = { value: ${S(e.ssr.serializer.stringify(s), { isScriptContext: true, wrap: true, json: true })}}`);
  }, onMatchSettled: _e }, e.serverSsr.injectScript(() => me, { logScript: false });
}
function he(e) {
  var r, t;
  const s = { manifest: e.ssr.manifest, dehydratedData: (t = (r = e.options).dehydrate) == null ? void 0 : t.call(r) };
  e.serverSsr.injectScript(() => `__TSR_SSR__.dehydrated = ${S(e.ssr.serializer.stringify(s), { isScriptContext: true, wrap: true, json: true })}`);
}
function Se(e, r) {
  const t = [];
  return { replaced: P(e, (n, o) => {
...
function _e(e) {
  ...
  if (t.loaderData !== void 0) {
    const a = Se(t.loaderData, { match: t });
    t.loaderData = a.replaced, s = a.extracted, n = s.reduce((m, f) => H(m, ["temp", ...f.path], void 0), { temp: a.replaced }).temp;
  }
  const o = `__TSR_SSR__.initMatch(${S({ id: t.id, __beforeLoadContext: r.ssr.serializer.stringify(t.__beforeLoadContext), loaderData: r.ssr.serializer.stringify(n), error: r.ssr.serializer.stringify(t.error), extracted: s == null ? void 0 : s.map((a) => pick(a, ["type", "path"])), updatedAt: t.updatedAt, status: t.status }, { isScriptContext: true, wrap: true, json: true })})`;
  r.serverSsr.injectScript(() => o), s && s.forEach((a) => a.type === "promise" ? i(a) : d(a));
  function i(a) {
    r.serverSsr.injectScript(async () => (await a.promise, `__TSR_SSR__.resolvePromise(${S({ matchId: t.id, id: a.id, promiseState: a.promise[TSR_DEFERRED_PROMISE] }, { isScriptContext: true, wrap: true, json: true })})`));
  }
  function d(a) {
    r.serverSsr.injectHtml(async () => {
      try {
        const m = a.stream.getReader();
        let f = null;
        for (; !(f = await m.read()).done; ) if (f.value) {
          const C = `__TSR_SSR__.injectChunk(${S({ matchId: t.id, id: a.id, chunk: f.value }, { isScriptContext: true, wrap: true, json: true })})`;
          r.serverSsr.injectScript(() => C);
        }
        r.serverSsr.injectScript(() => `__TSR_SSR__.closeStream(${S({ matchId: t.id, id: a.id }, { isScriptContext: true, wrap: true, json: true })})`);
      } catch (m) {
...
function H(e, r, t) {
  ...
  const [s, ...n] = r;
  return Array.isArray(e) ? e.map((o, i) => i === Number(s) ? H(o, n, t) : o) : isPlainObject$1(e) ? { ...e, [s]: H(e[s], n, t) } : e;
}
function P(e, r, t = []) {
  if (isPlainArray(e)) return e.map((n, o) => P(n, r, [...t, `${o}`]));
  if (isPlainObject$1(e)) {
    const n = {};
    for (const o in e) n[o] = P(e[o], r, [...t, o]);
    return n;
  }
  const s = r(e, t);
  return s !== e ? s : e;
}
function ye({ createRouter: e, getRouterManifest: r }) {
  return (t) => eventHandler(async (s) => {
    ...
    pe(a, r == null ? void 0 : r()), a.update({ history: d }), await a.load(), he(a);
    const m = Re({ event: s, router: a });
    return await t({ request: n, router: a, responseHeaders: m });
  });
}
function Re(e) {
  let r = N(getResponseHeaders(e.event), e.event.___ssrRpcResponseHeaders, { "Content-Type": "text/html; charset=UTF-8" }, ...e.router.state.matches.map((s) => s.headers));
  const { redirect: t } = e.router.state;
  return t && (r = N(r, t.headers, { Location: t.href })), r;
}
function ge(e, r) {
  return B(e, r);
}
function we(e, r) {
  return Readable$1.fromWeb(B(e, Readable$1.toWeb(r)));
}
const xe = /(<body)/, ve = /(<\/body>)/, be = /(<\/html>)/, Ce = /(<head.*?>)/, Te = /(<\/[a-zA-Z][\w:.-]*?>)/g, Ee = new TextDecoder();
function je() {
  let e;
...
function B(e, r) {
  const t = je();
  let s = true, n = "", o = "", i = false, d = false, a = "", m = "";
  function f() {
    const c = n;
    return n = "", c;
  }
  function C(c) {
    return c instanceof Uint8Array ? Ee.decode(c) : String(c);
  }
  ...
  const L = e.subscribe("onInjectedHtml", (c) => {
    A(c.promise);
  });
  function A(c) {
    g++, c.then((w) => {
  ...
  return R.then(() => {
    ...
    const w = C(c.value);
    let l = a + w;
    const T = l.match(ve), D = l.match(be);
    if (i || l.match(xe) && (i = true), !d) {
      const p = l.match(Ce);
      if (p) {
        d = true;
        const I = p.index, $ = p[0], W = l.slice(I + $.length);
        t.write(l.slice(0, I) + $ + f()), l = W;
      }
    }
    if (!i) {
      t.write(l), a = "";
    ...
    if (T && D && T.index < D.index) {
      const p = T.index;
      o = l.slice(p), t.write(l.slice(0, p) + f()), a = "";
      return;
    }
    let E, x = 0;
    for (; (E = Te.exec(l)) !== null; ) x = E.index + E[0].length;
    if (x > 0) {
      const p = l.slice(0, x) + f() + m;
      t.write(p), a = l.slice(x);
    } else a = l, m += f();
  }, onEnd: () => {
...
const Pe = async ({ request: e, router: r, responseHeaders: t }) => {
  if (typeof v.renderToReadableStream == "function") {
    const s = await v.renderToReadableStream(jsx(z, { router: r }), { signal: e.signal });
  ...
  if (typeof v.renderToPipeableStream == "function") {
    ...
    try {
      const o = v.renderToPipeableStream(jsx(z, { router: r }), { ...isbot(e.headers.get("User-Agent")) ? { onAllReady() {
        o.pipe(s);
      } } : { onShellReady() {
        o.pipe(s);
      } }, onError: (i, d) => {
...
}, Ae = () => ({ routes: { __root__: { filePath: "__root.tsx", children: ["/"], preloads: ["/_build/assets/client-CLP_h_y_.js", "/_build/assets/client-BD0x6cCO.js"] }, "/": { filePath: "index.tsx" } } });
function De(e) {
...
function Ie() {
  ...
  r.assets = r.assets || [];
  let t = "";
  const s = De("client"), n = (_a = s.inputs[s.handler]) == null ? void 0 : _a.output.path;
  return n || invariant$1(n, "Could not find client entry in vinxi manifest"), r.assets.push({ tag: "script", attrs: { type: "module", suppressHydrationWarning: true, async: true }, children: `${t}import("${n}")` }), e;
}
function $e() {
  const e = Ie();
...
const Oe = [{ charSet: "utf-8" }, { name: "viewport", content: "width=device-width, initial-scale=1" }, { title: "EcoPay - Secure Crypto Exchange" }], F = createRootRoute({ head: () => ({ meta: Oe }), component: Me, errorComponent: ({ error: e }) => jsx("div", { className: "min-h-screen flex items-center justify-center p-4 bg-background", children: jsxs("div", { className: "text-center space-y-4", children: [jsx("h1", { className: "text-2xl font-bold text-destructive", children: "Something went wrong!" }), jsx("p", { className: "text-muted-foreground", children: (e == null ? void 0 : e.message) || "An unexpected error occurred" }), jsx("a", { href: "/", className: "text-primary hover:underline", children: "Return to home" })] }) }) });
function Me() {
  return jsx(ze, { children: jsx(Outlet, {}) });
}
function ze({ children: e }) {
  return jsxs("html", { lang: "en", children: [jsx("head", { children: jsx(HeadContent, {}) }), jsxs("body", { children: [jsx("div", { id: "app", children: e }), jsx(Scripts, {})] })] });
}
const Ne = () => import('../build/index-CsObXEje.mjs'), k = createFileRoute("/")({ component: lazyRouteComponent(Ne, "component", () => k.ssr) }), Be = k.update({ id: "/", path: "/", getParentRoute: () => F }), Fe = { IndexRoute: Be }, ke = F._addFileChildren(Fe)._addFileTypes();
function Le() {
  return createRouter$2({ routeTree: ke, scrollRestoration: true });
}
const Ye = ye({ createRouter: Le, getRouterManifest: $e })(Pe);

const handlers = [
  { route: '', handler: _e4xTzM, lazy: false, middleware: true, method: undefined },
  { route: '/_server', handler: oe, lazy: false, middleware: true, method: undefined },
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/jonasgraterol/Development/TRINIDAPP/website/.data/kv"}));
