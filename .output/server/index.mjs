...
const appConfig$1 = {"name":"vinxi","routers":[{"name":"public","type":"static","dir":"./public","base":"/","root":"/Users/jonasgraterol/Development/TRINIDAPP/website","order":0,"outDir":"/Users/jonasgraterol/Development/TRINIDAPP/website/.vinxi/build/public"},{"name":"client","type":"client","target":"browser","handler":"app/client.tsx","base":"/_build","build":{"sourcemap":true},"root":"/Users/jonasgraterol/Development/TRINIDAPP/website","outDir":"/Users/jonasgraterol/Development/TRINIDAPP/website/.vinxi/build/client","order":1},{"name":"ssr","type":"http","target":"server","handler":"app/ssr.tsx","link":{"client":"client"},"root":"/Users/jonasgraterol/Development/TRINIDAPP/website","base":"/","outDir":"/Users/jonasgraterol/Development/TRINIDAPP/website/.vinxi/build/ssr","order":2},{"name":"server","type":"http","target":"server","base":"/_server","handler":"node_modules/@tanstack/start-server-functions-handler/dist/esm/index.js","root":"/Users/jonasgraterol/Development/TRINIDAPP/website","outDir":"/Users/jonasgraterol/Development/TRINIDAPP/website/.vinxi/build/server","order":3}],"server":{"preset":"bun","experimental":{"asyncContext":true}},"root":"/Users/jonasgraterol/Development/TRINIDAPP/website"};
				const buildManifest = {"client":{"/Users/jonasgraterol/Development/TRINIDAPP/website/app/styles/app.css":{"file":"assets/app-CY7WGVNl.css","src":"/Users/jonasgraterol/Development/TRINIDAPP/website/app/styles/app.css"},"_client-D-2rl7ld.js":{"file":"assets/client-D-2rl7ld.js","name":"client","dynamicImports":["app/routes/index.tsx?tsr-split=component"],"assets":["assets/app-CY7WGVNl.css"]},"app/routes/index.tsx?tsr-split=component":{"file":"assets/index-DKTG0pJo.js","name":"index","src":"app/routes/index.tsx?tsr-split=component","isDynamicEntry":true,"imports":["_client-D-2rl7ld.js"]},"virtual:$vinxi/handler/client":{"file":"assets/client-Bpvzk9ya.js","name":"client","src":"virtual:$vinxi/handler/client","isEntry":true,"imports":["_client-D-2rl7ld.js"]}},"ssr":{"/Users/jonasgraterol/Development/TRINIDAPP/website/app/styles/app.css":{"file":"assets/app-CY7WGVNl.css","src":"/Users/jonasgraterol/Development/TRINIDAPP/website/app/styles/app.css"},"app/routes/index.tsx?tsr-split=component":{"file":"assets/index-CsObXEje.js","name":"index","src":"app/routes/index.tsx?tsr-split=component","isDynamicEntry":true,"imports":["virtual:$vinxi/handler/ssr"]},"virtual:$vinxi/handler/ssr":{"file":"ssr.js","name":"ssr","src":"virtual:$vinxi/handler/ssr","isEntry":true,"dynamicImports":["app/routes/index.tsx?tsr-split=component"],"assets":["assets/app-CY7WGVNl.css"]}},"server":{"virtual:$vinxi/handler/server":{"file":"server.js","name":"server","src":"virtual:$vinxi/handler/server","isEntry":true}}};
...
function J(e) {
  var _a;
  return (_a = e.web) != null ? _a : e.web = { request: W$1(e), url: q(e) }, e.web.request;
}
function U() {
  return $();
}
...
function he(e, r) {
  ...
  }, onMatchSettled: ye }, e.serverSsr.injectScript(() => me, { logScript: false });
}
function Se(e) {
  var r, t;
...
function ye(e) {
  ...
  if (t.loaderData !== void 0) {
    const a = _e(t.loaderData, { match: t });
    t.loaderData = a.replaced, s = a.extracted, n = s.reduce((p, f) => P(p, ["temp", ...f.path], void 0), { temp: a.replaced }).temp;
  }
...
function P(e, r, t) {
  ...
  const [s, ...n] = r;
  return Array.isArray(e) ? e.map((o, i) => i === Number(s) ? P(o, n, t) : o) : isPlainObject$1(e) ? { ...e, [s]: P(e[s], n, t) } : e;
}
function A(e, r, t = []) {
  if (isPlainArray(e)) return e.map((n, o) => A(n, r, [...t, `${o}`]));
  if (isPlainObject$1(e)) {
    const n = {};
    for (const o in e) n[o] = A(e[o], r, [...t, o]);
    return n;
  }
  const s = r(e, t);
  return s !== e ? s : e;
}
function Re({ createRouter: e, getRouterManifest: r }) {
  return (t) => eventHandler(async (s) => {
    ...
    he(a, r == null ? void 0 : r()), a.update({ history: d }), await a.load(), Se(a);
    const p = ge({ event: s, router: a });
    return await t({ request: n, router: a, responseHeaders: p });
  });
}
function ge(e) {
...
function xe(e, r) {
  return Readable$1.fromWeb(W(e, Readable$1.toWeb(r)));
}
const ve = /(<body)/, be = /(<\/body>)/, Ce = /(<\/html>)/, Te = /(<head.*?>)/, Ee = /(<\/[a-zA-Z][\w:.-]*?>)/g, je = new TextDecoder();
function He() {
  let e;
...
function W(e, r) {
  const t = He();
  let s = true, n = "", o = "", i = false, d = false, a = "", p = "";
  function f() {
    const c = n;
    return n = "", c;
  }
  function C(c) {
    return c instanceof Uint8Array ? je.decode(c) : String(c);
  }
  ...
  return R.then(() => {
    ...
    const w = C(c.value);
    let l = a + w;
    const T = l.match(be), I = l.match(Ce);
    if (i || l.match(ve) && (i = true), !d) {
      const m = l.match(Te);
      if (m) {
        d = true;
        const $ = m.index, O = m[0], q = l.slice($ + O.length);
        t.write(l.slice(0, $) + O + f()), l = q;
      }
    }
    if (!i) {
      t.write(l), a = "";
    ...
    if (T && I && T.index < I.index) {
      const m = T.index;
      o = l.slice(m), t.write(l.slice(0, m) + f()), a = "";
      return;
    }
    let E, x = 0;
    for (; (E = Ee.exec(l)) !== null; ) x = E.index + E[0].length;
    if (x > 0) {
      const m = l.slice(0, x) + f() + p;
      t.write(m), a = l.slice(x);
    } else a = l, p += f();
  }, onEnd: () => {
...
const Ae = async ({ request: e, router: r, responseHeaders: t }) => {
  if (typeof v.renderToReadableStream == "function") {
    const s = await v.renderToReadableStream(jsx(N, { router: r }), { signal: e.signal });
  ...
  if (typeof v.renderToPipeableStream == "function") {
    ...
    try {
      const o = v.renderToPipeableStream(jsx(N, { router: r }), { ...isbot(e.headers.get("User-Agent")) ? { onAllReady() {
        o.pipe(s);
      } } : { onShellReady() {
        o.pipe(s);
      } }, onError: (i, d) => {
...
}, De = () => ({ routes: { __root__: { filePath: "__root.tsx", children: ["/"], preloads: ["/_build/assets/client-Bpvzk9ya.js", "/_build/assets/client-D-2rl7ld.js"] }, "/": { filePath: "index.tsx" } } });
function Ie(e) {
  return globalThis.MANIFEST[e];
}
function $e() {
  var _a;
  const e = De(), r = e.routes.__root__ = e.routes.__root__ || {};
  r.assets = r.assets || [];
  let t = "";
  const s = Ie("client"), n = (_a = s.inputs[s.handler]) == null ? void 0 : _a.output.path;
...
const Me = "/_build/assets/app-CY7WGVNl.css", j = { suppressHydrationWarning: true }, B = createRootRoute({ head: () => ({ meta: [{ charSet: "utf-8" }, { name: "viewport", content: "width=device-width, initial-scale=1" }, { title: "EcoPay - Secure Crypto Exchange" }], links: [{ rel: "stylesheet", href: Me }] }), component: ze, errorComponent: ({ error: e }) => jsx("div", { className: "min-h-screen flex items-center justify-center p-4 bg-background", children: jsxs("div", { className: "text-center space-y-4", children: [jsx("h1", { className: "text-2xl font-bold text-destructive", children: "Something went wrong!" }), jsx("p", { className: "text-muted-foreground", children: (e == null ? void 0 : e.message) || "An unexpected error occurred" }), jsx("a", { href: "/", className: "text-primary hover:underline", children: "Return to home" })] }) }) });
function ze() {
  return jsx(Ne, { children: jsx(Outlet, {}) });
}
function Ne({ children: e }) {
  return jsxs("html", { ...j, children: [jsx("head", { ...j, children: jsx(HeadContent, {}) }), jsxs("body", { ...j, children: [jsx("div", { id: "app", children: e }), jsx(Scripts, {})] })] });
}
const ke = () => import('./chunks/build/index-CsObXEje.mjs'), F = createFileRoute("/")({ component: lazyRouteComponent(ke, "component", () => F.ssr) }), We = F.update({ id: "/", path: "/", getParentRoute: () => B }), Be = { IndexRoute: We }, Fe = B._addFileChildren(Be)._addFileTypes();
function Le() {
  return createRouter$2({ routeTree: Fe, scrollRestoration: true });
}
const et = Re({ createRouter: Le, getRouterManifest: Oe })(Ae);

const handlers = [
  { route: '/_server', handler: oe, lazy: false, middleware: true, method: undefined },
  { route: '/', handler: et, lazy: false, middleware: true, method: undefined }
];
